...
The output of the program is a quotation. There is a total of 5 different quotations, the input value identifies the particular quotation to print out. The quotations are listed in the sample runs below. Please note the quotation is printed with a newline character (\n) at the end.
...
the integer read from the input is outside of interval [1 to 5].
